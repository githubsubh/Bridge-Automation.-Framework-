...
class HomePage(BasePage):
    ...
    def navigate_to_teacher_login(self):
        ...
        try:
            ...
            try:
                ...
                self.logger.warning(f"Direct click also failed: {e2}")
    ...
    def click_cmenu_login(self):
        """Alias for navigate_to_teacher_login — navigates to the Teacher Login page."""
        self.navigate_to_teacher_login()
