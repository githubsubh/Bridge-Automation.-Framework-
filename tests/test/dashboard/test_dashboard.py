...
class Test_003_DashboardFeatures:
    ...
    def test_dashboard_features(self, setup):
        ...
        try:
            ...
            time.sleep(8)  # Wait for dashboard to stabilize (INCREASED for better visibility)
            ...
            for idx, (section_name, verify_func) in enumerate(sections, 1):
                ...
                try:
                    ...
                    if idx < len(sections):
                        time.sleep(5)  # 5 seconds so user can clearly see each verification
            ...
            time.sleep(6)  # LONGER pause so user can see summary before logout
